...
<div class="space-y-2">
    ...
    <textarea
        ...
        {{ $attributes->merge([
            'class' => 'w-full px-3 py-2.5 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 resize-y text-sm sm:text-base ' . 
                ($hasError 
