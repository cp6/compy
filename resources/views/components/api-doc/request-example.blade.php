...
<div class="space-y-4">
    ...
    <div>
        ...
        <div class="bg-gray-900 dark:bg-gray-950 rounded-lg p-4 overflow-x-auto">
            <code class="text-sm text-green-400 font-mono">
                <span class="text-gray-400">{{ strtoupper($method) }}</span> {{ $url }}
            </code>
        </div>
    </div>
    ...
    @if(!empty($queryParams))
        <div>
            ...
            <div class="bg-gray-900 dark:bg-gray-950 rounded-lg p-4 overflow-x-auto">
                <code class="text-sm text-gray-300 dark:text-gray-200 font-mono">
    ...
    @if(!empty($headers))
        <div>
            ...
            <div class="bg-gray-900 dark:bg-gray-950 rounded-lg p-4 overflow-x-auto">
                <pre class="text-sm text-gray-300 dark:text-gray-200 font-mono"><code>@foreach($headers as $key => $value){{ $key }}: {{ $value }}
@endforeach</code></pre>
            </div>
        </div>
    @endif
