                    ...
                    <tr>
                        <td style="padding: 48px 40px;">
                            ...
                            <p style="margin: 0 0 32px 0; color: #6b7280; font-size: 15px; line-height: 1.7;">
                                {{ __('Thanks for signing up! Please click the button below to verify your email address and complete your registration.') }}
                            </p>
                            ...
                            <div style="border-top: 1px solid #e5e7eb; padding-top: 24px; margin-top: 32px;">
                                <p style="margin: 0 0 12px 0; color: #9ca3af; font-size: 13px; line-height: 1.6;">
                                    {{ __('This verification link will expire in :count minutes.', ['count' => $count]) }}
                                </p>
